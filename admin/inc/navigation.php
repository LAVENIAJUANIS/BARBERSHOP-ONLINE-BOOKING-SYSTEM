...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-light elevation-4 sidebar-no-expand bg-gradient">
        <!-- Brand Logo -->
                   ...
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=services" class="nav-link nav-services">
					   ...
					   <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=haircares" class="nav-link nav-haircares">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Hair Care List
                        </p>
					...
					<li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=barbers" class="nav-link nav-barbers">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Barber List
                        </p>
					...
					<li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=hairproduct" class="nav-link nav-hairproduct">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Hair product List
                        </p>
					...
					<li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=hairstyles" class="nav-link nav-hairstyles">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Hairstyles List
                        </p>
					...
					<li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=gallery" class="nav-link nav-gallery">
